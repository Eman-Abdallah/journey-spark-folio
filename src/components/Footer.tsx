...
const Footer = () => {
  ...
  return (
    <footer className="bg-theme-lightBlue py-10 px-6">
      <div className="container-lg">
        <div className="flex flex-col md:flex-row items-center justify-between">
          <div className="mb-4 md:mb-0">
            <p className="text-theme-slate text-center md:text-left">
          ...
          <div className="flex items-center gap-6">
            <a 
              ...
              className="text-theme-slate hover:text-theme-highlight transition-colors font-bold"
              aria-label="GitHub"
            >
          ...
          <button
            onClick={scrollToTop}
            className="mt-4 md:mt-0 p-2 rounded-full bg-theme-highlight/10 hover:bg-theme-highlight/20 transition-all"
            aria-label="Scroll to top"
          >
            <ChevronUp size={20} className="text-theme-highlight" />
          </button>
        </div>
      </div>
    </footer>
